...
//interface dùng để định nghĩa, mô tả cấu trúc của 1 user cần những gì, bắt buộc phải có những gì khi tạo ra
interface UserType {
  //UserType định nghĩa một đối tượng thì phải có thuộc tính nào
  //bắt buộc phải có những thuộc tính nào, những thuộc tính nào ko cần
...
//Class User là cái khuôn dùng để đúc ra object User
//Object này sẽ dùng UserType để định nghĩa cấu trúc của nó (user)
//=> khi tạo ra một object User thì phải truyền vào đúng cấu trúc của UserType
